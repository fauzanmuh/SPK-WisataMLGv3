<?php
	...
	if (isset($_POST['submit'])) {
		...
		mysqli_query($db, "INSERT INTO nilai_fuzzy(id_alternatif, id_kriteria_fuzzy, nilai, bawah, tengah, atas) VALUES('$_POST[id_alternatif]', '$_POST[id_kriteria_fuzzy]', 
        '$_POST[nilai]', '$bawah', '$tengah', '$atas')");
		echo "<script>alert('Data berhasil disimpan.');window.location='nilai-fuzzy.php';</script>";
	}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Nilai Fuzzy</h6>
                        </div>

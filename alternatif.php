...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="my-2"></div>
                            <a href="add-alternatif.php" class="btn btn-success btn-icon-split">
    ...
    ?>
                                    <tr>
                                        <td align="center"><?php echo $row['id_alternatif']; ?></td>
                                        <td align="center"><?php echo $row['nama_alternatif']; ?></td>
                                        <td align="center"><?php echo $row['deskripsi']; ?></td>
                                        <td style="text-align: center;"><img
                                                src="assets/wisata/<?php echo $row['gambar_wisata']; ?>"
                                                style="width: 50%;"></td>
                                        <td align="center"><?php echo $row['website']; ?></td>
                                        <td align="center"><a
                                                href="edit-alternatif.php?id_alternatif=<?php echo $row['id_alternatif']; ?>"><button
                                                    class="btn btn-primary btn-sm">Edit</button></a>
                                            <a
                                                href="del-alternatif.php?id_alternatif=<?php echo $row['id_alternatif']; ?>"><button

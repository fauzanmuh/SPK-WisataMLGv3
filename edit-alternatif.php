                    ...
                    <table width="450" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
                        ...
                        <tr>
                            ...
                            <td width="267" bgcolor="#FFFFFF"><input type="text" name="nama_alternatif"
                                    id="nama_alternatif" value="<?php echo $dataalternatif['nama_alternatif']; ?>" />
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">Deskripsi</td>
                            <td bgcolor="#FFFFFF"><textarea name="deskripsi" cols="30" rows="4"
                                    id="deskripsi"><?php echo $dataalternatif['deskripsi']; ?></textarea></td>
                        </tr>
                        <tr>
                            <td width="160" bgcolor="#FFFFFF">Website</td>
                            <td width="267" bgcolor="#FFFFFF"><input type="text" name="website" id="website"
                                    value="<?php echo $dataalternatif['website']; ?>" /></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">Gambar</td>
                            <td bgcolor="#FFFFFF"><input type="file"
                                    name="gambar_wisata" /><?php echo $dataalternatif['gambar_wisata']; ?></td>
                        </tr>
                        <tr>

        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" bgcolor="#000099">
          ...
          <tr>
            ...
            <td width="236" bgcolor="#FFFFFF"><select name="id_alternatif" id="id_alternatif">
              ...
              <?php
				...
				?>
              <option value="<?php echo $dataalternatif['id_alternatif']; ?>" <?php if ($datanilai['id_alternatif'] == $dataalternatif['id_alternatif']) { echo " selected"; } ?>>
          ...
          <tr>
            ...
            <td width="249" bgcolor="#FFFFFF"><select name="id_kriteria_fuzzy" id="id_kriteria_fuzzy">
				...
				?>
                <option value="<?php echo $datakriteria['id_kriteria_fuzzy']; ?>" <?php if ($datanilai['id_kriteria_fuzzy'] == $datakriteria['id_kriteria_fuzzy']) { echo " selected"; } ?>>

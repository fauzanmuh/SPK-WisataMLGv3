...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2023 at 08:18 AM
...
INSERT INTO `alternatif` (`id_alternatif`, `nama_alternatif`, `deskripsi`, `gambar_wisata`) VALUES
('AKB', 'Alun-Alun Kota Batu', '', NULL),
('AKM', 'Alun-Alun Kota Malang', '', NULL),
('BLG', 'Batu Love Garden', '', NULL),
('BNS', 'Batu Night Spectacular', '', NULL),
('CB', 'Candi Badut', '', NULL),
('CP', 'Coban Putri', '', NULL),
('CR', 'Coban Rondo', '', NULL),
('CS', 'Candi Singosari', '', NULL),
('CT', 'Coban Talun', '', NULL),
('CWO', 'Coban Watu Ondo', 'Wisata Alam', NULL),
('EGP', 'Eco Green Park', 'Wisata dengan beraneka ragam fauna', NULL),
('FST', 'Florawisata San Terra', '', NULL),
('GP', 'Goa Pinus', '', NULL),
('HW', 'Hawai Waterpark', 'Wahana air', NULL),
('JTP1', 'Jatim Park 1', '', NULL),
('JTP2', 'Jatim Park 2', '', NULL),
('JTP3', 'Jatim Park 3', '', NULL),
('KBP', 'Kampung Budaya Polowijen', '', NULL),
('KT', 'Kampung Tridi', 'Kampung yang nyentrik', NULL),
('KTW', 'Kebun Teh Wonosari', '', NULL),
('MA', 'Museum Angkut', '', NULL),
('MB', 'Museum Brawijaya', '', NULL),
('MMP', 'Museum Mpu Purwa', '', NULL),
('MMTD', 'Museum Malang Tempoe Doeloe', '', NULL),
('OK', 'Omah Kayu', '', NULL),
('PB', 'Pantai Balekambang', '', NULL),
('PBM', 'Pantai Bajulmati', '', NULL),
('PLG', 'Paralayang', '', NULL),
('PN', 'Pantai Ngliyep', '', NULL),
('PSB', 'Pantai Sendangbiru', '', NULL),
('PTA', 'Pantai Teluk Asmara', 'Pantai yang berada di Malang Selatan', NULL),
('PTT', 'Pantai Tiga Warna', '', NULL),
('SS', 'Sumber Sirah', 'Wisata Sumber Air', NULL),
('Tes', 'TES', 'sgs', 'paralayang.jpg');
...
(1, 'Eco Green Park', 'jtp.id', 'Jl. Jl. Raya Oro-Oro Ombo No.9A, Sisir, Kec. Batu, Kota Batu, Jawa Timur 65314', '-7.8886606', '112.5276998', 'EGP'),
(2, 'Coban Watu Ondo', 'pinhome.id/info-area/coban-kembar-watu-ondo', 'Bagean Borah, Madiredo, Kec. Pujon, Kabupaten Malang, Jawa Timur 65392', '-7.783541', '112.4547438', 'CWO'),
(3, 'Coban Putri', 'dolanyok.com/air-terjun-coban-putri', 'Jalur Lkr. Bar., Oro-Oro Ombo, Kec. Batu, Kota Batu, Jawa Timur 65316', '-7.912707', '112.526767', 'CP'),
(4, 'Coban Talun', 'salsawisata.com/air-terjun-coban-talun', 'Dusun Wonorejo, Desa Tulungrejo, Bumiaji, Kota Batu, Jawa Timur', '-7.8039181', '112.5061791', 'CT'),
(5, 'Coban Rondo', 'salsawisata.com/air-terjun-coban-rondo', 'Jl. Coban Rondo, Krajan, Pandesari, Kec. Pujon, Kabupaten Malang, Jawa Timur 65391', '-7.884994', '112.477319', 'CR'),
(6, 'Hawai Waterpark', 'hawaiwaterpark.com', 'Jl. Graha Kencana Utara V, Karanglo, Banjararum, Kec. Singosari, Kabupaten Malang, Jawa Timur 65153', '-7.9232799', '112.6571', 'HW'),
(7, 'Pantai Teluk Asmara', 'travelspromo.com/htm-wisata/pantai-teluk-asmara-malang', 'Tambak, Sitiarjo, Kec. Sumbermanjing Wetan, Kabupaten Malang, Jawa Timur 65176', '-8.4429422', '112.6654655', 'PTA'),
(8, 'Pantai Balekambang', 'travelspromo.com/htm-wisata/pantai-balekambang-malang', 'Jl. Bale Kambang, Surigondo, Srigonco, Kec. Bantur, Kabupaten Malang, Jawa Timur 65179', '-8.4031095', '112.5358953', 'PB'),
(9, 'Pantai Ngliyep', 'piknikwisata.com/jatim/malang/pantai/ngliyep', 'Desa, Hutan, Kedungsalam, Kec. Donomulyo, Kabupaten Malang, Jawa Timur 65167', '-8.3835873', '112.4242054', 'PN'),
(10, 'Pantai Sendangbiru', 'sikidang.com/pantai-sendang-biru', 'Sendangbiru, Tambakrejo, Kec. Sumbermanjing Wetan, Kabupaten Malang, Jawa Timur 65176', '-8.431425', '112.6860615', 'PSB'),
(11, 'Pantai Tiga Warna', 'sikidang.com/pantai-tiga-warna', 'Jl. Sendang Biru, Area Sawah/Kebun, Tambakrejo, Kec. Sumbermanjing Wetan, Kabupaten Malang, Jawa Timur 65176', '-8.4391425', '112.6674944', 'PTT'),
(12, 'Pantai Bajulmati', 'sikidang.com/pantai-bajul-mati', 'Jl. Prempatan Jls pantai, Umbulrejo, bajulmati, Gedangan, Kabupaten Malang, Jawa Timur 65178', '-8.4284642', '112.6361241', 'PBM'),
(13, 'Kampung Tridi', 'atourin.com/destination/malang/kampung-tridi', 'Jl. Temenggungan Ledok, Kesatrian, Kec. Blimbing, Kota Malang, Jawa Timur 65121', '-7.981849', '112.6355354', 'KT'),
(14, 'Sumber Sirah', 'sikidang.com/sumber-sirah', 'Jalan Sunan Kalijaga I RT.05/RW.02, Putuk Utara, Putukrejo, Kec. Gondanglegi, Kabupaten Malang, Jawa Timur 65174', '-8.1229106', '112.6180274', 'SS'),
(15, 'Omah Kayu', 'salsawisata.com/omah-kayu-malang', 'Jl. Gn. Banyak, Gunungsari, Kec. Bumiaji, Kota Batu, Jawa Timur 65312', '-7.8549492', '112.4952355', 'OK'),
(16, 'Paralayang', 'penginapan.net/harga-tiket-masuk-fasilitas-dan-biaya-paralayang-batu-malang', 'Jl. Brigjend Abd Manan Wijaya No.186, Maron, Pandesari, Kec. Pujon, Kabupaten Malang, Jawa Timur 65391', '-7.8550438', '112.4942235', 'PLG'),
(17, 'Museum Malang Tempoe Doeloe', 'sikidang.com/museum-malang-tempo-doeloe', 'Jl. Gajahmada, Kiduldalem, Kec. Klojen, Kota Malang, Jawa Timur 65119', '-7.9789589', '112.6323569', 'MMTD'),
(18, 'Goa Pinus', 'travelspromo.com/htm-wisata/goa-pinus-batu', 'Gunungsari, Kec. Bumiaji, Kota Batu, Jawa Timur 65337', '-7.8488572', '112.4915294', 'GP'),
(19, 'Museum Brawijaya', 'salsawisata.com/museum-brawijaya', 'Jl. Besar Ijen No.25A, Gading Kasri, Kec. Klojen, Kota Malang, Jawa Timur 65115', '-7.9721325', '112.6186394', 'MB'),
(20, 'Jawa Timur Park 1', 'jtp.id/jatimpark1/mobile', 'Jl. Kartika No.2, Sisir, Kec. Batu, Kota Batu, Jawa Timur 65315', '-7.884152', '112.5222573', 'JTP1'),
(21, 'Jawa Timur Park 2', 'jtp.id/batusecretzoo', 'Jl. Raya Oro-Oro Ombo No.9, Temas, Kec. Batu, Kota Batu, Jawa Timur 65315', '-7.888021', '112.5269746', 'JTP2'),
(22, 'Jawa Timur Park 3', 'jtp.id/jatimpark3/mobile', 'Jl. Ir. Soekarno No.144, Beji, Kec. Junrejo, Kota Batu, Jawa Timur 65236', '-7.8971338', '112.5505331', 'JTP3'),
(23, 'Alun-Alun Kota Batu', 'travelspromo.com/htm-wisata/alun-alun-kota-wisata-batu', 'Jl. Diponegoro, Sisir, Kec. Batu, Kota Batu, Jawa Timur 65314', '-7.8711707', '112.5243562', 'AKB'),
(24, 'Batu Night Spectacular', 'jtp.id/bns/mobile/', 'Jl. Hayam Wuruk No.1, Oro-Oro Ombo, Kec. Batu, Kota Batu, Jawa Timur 65316', '-7.8965265', '112.5334589', 'BNS'),
(25, 'Museum Angkut', 'jtp.id/museumangkut/', 'Jl. Terusan Sultan Agung No.2, Ngaglik, Kec. Batu, Kota Batu, Jawa Timur 65314', '-7.878809', '112.5173998', 'MA'),
(26, 'Batu Love Garden', 'jtp.id/batulovegarden/', 'Jl. Raya Pandanrejo No.91, Pandanrejo, Kec. Bumiaji, Kota Batu, Jawa Timur 65332', '-7.8639275', '112.540267', 'BLG'),
(27, 'Florawisata Santerra De Laponte', 'travelspromo.com/htm-wisata/flora-wisata-san-terra-malang/', 'Jalan Raya Madya, Jurangrejo, Pandesari, Kec. Pujon, Kabupaten Malang, Jawa Timur 65391', '-7.8541183', '112.4857375', 'FST'),
(28, 'Kebun Teh Wonosari', 'sikidang.com/kebun-teh-wonosari/', 'RT.04/RW.07, Bodean Putuk, Toyomarto, Kec. Singosari, Kabupaten Malang, Jawa Timur 65153', '-7.8204902', '112.6405753', 'KTW'),
(29, 'Alun-Alun Kota Malang', 'salsawisata.com/alun-alun-kota-malang/', 'Jl. Merdeka Selatan, Kiduldalem, Kec. Klojen, Kota Malang, Jawa Timur 65119', '-7.9826145', '112.6282364', 'AKM'),
(30, 'Museum Mpu Purwa', 'tempatwisata.pro/wisata/Museum-Mpu-Purwa', 'Perumahan Griya Santa, Jl. Soekarno - Hatta No.210, Mojolangu, Lowokwaru, Kota Malang, Jawa Timur 65141', '-7.9404409', '112.6182048', 'MMP'),
(31, 'Candi Badut', 'sikidang.com/candi-badut/', 'Jl. Raya Candi V No.5D, Doro, Karangwidoro, Kec. Dau, Kota Malang, Jawa Timur 65146', '-7.9577701', '112.596042', 'CB'),
(32, 'Candi Singosari', 'salsawisata.com/candi-singosari/', 'Jl. Kertanegara, Candirenggo, Kec. Singosari, Kabupaten Malang, Jawa Timur 65153', '-7.8878045', '112.6589051', 'CS'),
(33, 'Kampung Budaya Polowijen', 'atourin.com/destination/malang/kampung-budaya-polowijen', 'Polowijen, Kec. Blimbing, Kota Malang, Jawa Timur 65126', '-7.9297107', '112.6410554', 'KBP');
...
--
ALTER TABLE `wisata`
  MODIFY `id_wisata` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
COMMIT;

...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="my-2"></div>
                            <a href="add-kriteria-fuzzy.php" class="btn btn-success btn-icon-split">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellpadding="0" cellspacing="1">
                                    <tr>
                                        <td align="center">ID Kriteria Fuzzy</td>
                                        <td align="center">Nama Kriteria Fuzzy</td>
                                        <td align="center">Batas Bawah</td>
                                        <td align="center">Batas Tengah</td>
                                        <td align="center">Batas Atas</td>
                                        <td align="center">Nama Bawah</td>
                                        <td align="center">Nama Tengah</td>
                                        <td align="center">Nama Atas</td>
      ...
      $query = "SELECT * FROM kriteria_fuzzy ORDER BY id_kriteria_fuzzy ASC LIMIT $limit_start, $limit";
      ...
      while ($row = $res1->fetch_assoc()) {
		?>
                                    <tr>
                                        <td><?php echo $row['id_kriteria_fuzzy']; ?></td>
                                        <td><?php echo $row['nama_kriteria_fuzzy']; ?></td>
                                        <td><?php echo $row['batas_bawah']; ?></td>
                                        <td><?php echo $row['batas_tengah']; ?></td>
                                        <td><?php echo $row['batas_atas']; ?></td>
                                        <td><?php echo $row['nama_bawah']; ?></td>
                                        <td><?php echo $row['nama_tengah']; ?></td>
                                        <td><?php echo $row['nama_atas']; ?></td>
                                        <td align="center"><a
                                                href="edit-kriteria-fuzzy.php?id_kriteria_fuzzy=<?php echo $row['id_kriteria_fuzzy']; ?>"><button
                                                    class="btn btn-primary btn-sm">Edit</button></a>
                                            <a
                                                href="del-kriteria-fuzzy.php?id_kriteria_fuzzy=<?php echo $row['id_kriteria_fuzzy']; ?>"><button
		...
		?>
                                ...
                                <?php
  $query_jumlah = "SELECT count(*) AS jumlah FROM kriteria_fuzzy";

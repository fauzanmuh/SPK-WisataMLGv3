...
<body id="page-top">
    ...
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Nilai Fuzzy</h6>
                        </div>
                        <div class="card-body">
                            <div class="my-2"></div>
                            <a href="add-nilai-fuzzy.php" class="btn btn-success btn-icon-split">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellpadding="0" cellspacing="1">
                                    <tr>
                                        <td align="center">Nama Alternatif</td>
      ...
      $res1 = $hal->get_result();
		...
		?>
                                    <tr>
                                        <td align="center"><?php echo $dataalternatif['nama_alternatif']; ?></td>
                                        <td align="center"><?php echo $datakriteria['nama_kriteria_fuzzy']; ?></td>
                                        <td align="center"><?php echo $datanilai['nilai']; ?></td>
                                        <td align="center"><?php echo number_format ($datanilai['bawah'],2); ?></td>
                                        <td align="center"><?php echo number_format ($datanilai['tengah'],2); ?></td>
                                        <td align="center"><?php echo number_format ($datanilai['atas'],2); ?></td>
                                        <td align="center"><a
                                                href="edit-nilai-fuzzy.php?id_nilai_fuzzy=<?php echo $datanilai['id_nilai_fuzzy']; ?>"><button
                                                    class="btn btn-primary btn-sm">Edit</button></a>
                                            <a
                                                href="del-nilai-fuzzy.php?id_nilai_fuzzy=<?php echo $datanilai['id_nilai_fuzzy']; ?>"><button

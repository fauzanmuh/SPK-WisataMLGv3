...
<body>
        ...
        <form class="row g-3 mt-1" id="kategori" name="form1" method="post" action="">
            ...
            <div class="col-md-4">
                ...
                <select id="inputState" class="form-select"
                    name="kriteria<?php echo $datakriteriafuzzy['id_kriteria_fuzzy']; ?>"
                    id="kriteria<?php echo $datakriteriafuzzy['id_kriteria_fuzzy']; ?>" class="inputan">
            ...
            <div class="col-md-5">
                <input type="submit" name="button" id="button" value="Proses"
                    class="tombol btn btn-primary hasil_btn" />
            </div>
        </form>
    </div>
    <?php
                ...
                <table border="0" class="table table-hover">
                    <tr class="table-dark">
                        ...
                        <?php
							...
							while ($datakriteriafuzzy = mysqli_fetch_array($querykriteriafuzzy)) {
							?>
                        <th><?php echo $datakriteriafuzzy['nama_kriteria_fuzzy']; ?>
                            <?php echo $datakriteriafuzzy['nama_bawah']; ?></th>
                        <th><?php echo $datakriteriafuzzy['nama_kriteria_fuzzy']; ?>
                            <?php echo $datakriteriafuzzy['nama_tengah']; ?></th>
                        <th><?php echo $datakriteriafuzzy['nama_kriteria_fuzzy']; ?>
                            <?php echo $datakriteriafuzzy['nama_atas']; ?></th>
                        <?php
							}
							?>
                    </tr>
    ...
    <div class="container">
        <input type="button" class="btn btn-primary rounded-3 mt-2" value="Lihat Hasil Detail"
            style="visibility: hidden" onclick="document.getElementById('perhitungan').style.display='block';" />
    ...
    <?php
		...
		?>
    <div class="container mb-5">
        <label class="mt-2 h6" for="">Berdasarkan kriteria yang diinginkan, sistem merekomendasikan destinasi
            wisata</label>
        <?php
				for ($i = 0; $i < count($id_alternatif); $i++) {
    ...
    <?php
		...
		?>
    <div class="container mb-5">
        <label for="">Yah, Sayang banget hasil tidak ditemukan <i class="uil uil-sad-squint"></i> dicari lagi yuk sesuai
            kategori..</label>
    </div>
    <?php
		}
